...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6 bg-gray-900 border border-red-500/30 rounded-lg">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'password','value' => 'Kata Sandi Anda','class' => 'sr-only']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'password','value' => 'Kata Sandi Anda','class' => 'sr-only']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-full bg-gray-800/50 border-red-700/50 text-white rounded-lg focus:border-red-400 focus:ring-1 focus:ring-red-400 transition','placeholder' => 'Masukkan kata sandi untuk konfirmasi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-full bg-gray-800/50 border-red-700/50 text-white rounded-lg focus:border-red-400 focus:ring-1 focus:ring-red-400 transition','placeholder' => 'Masukkan kata sandi untuk konfirmasi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-bold bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">
                    ...
                    <?php echo e(__('Ya, Hapus Akun Saya')); ?>
...
<?php endif; ?>
</section><?php /**PATH D:\07_ProjectKuliah\yuwaraja2026\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>