        ...
        <div class="space-y-6">
            ...
            <div class="glass-card p-6 md:p-8 animate-fade-in">
                ...
                <div class="border-b border-slate-700/50 pb-6 mb-6">
                    <h2 class="font-display text-2xl md:text-3xl font-bold text-white mb-4 leading-tight"><?php echo e($item->judul); ?></h2>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 sm:gap-8 mb-4">
                        <div class="meta-info">
                            ...
                            <span><?php echo e(($item->published_at ?? $item->created_at)->format('d F Y, H:i')); ?></span>
                        </div>
                        <div class="meta-info">
                    ...
                    <p class="text-white leading-relaxed text-lg">
                        <?php echo e(Str::limit(strip_tags($item->isi ?? $item->konten ?? 'Tidak ada konten tersedia'), 200)); ?>
                ...
                <div class="flex justify-end">
                    <a href="<?php echo e(route('mahasiswa.pengumuman.detail', $item->id)); ?>" class="btn-primary">
        ...
        <div class="glass-card p-6 animate-fade-in">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-sm text-gray-400">
                    Menampilkan <?php echo e($pengumuman->firstItem() ?? 0); ?> - <?php echo e($pengumuman->lastItem() ?? 0); ?> dari <?php echo e($pengumuman->total()); ?> pengumuman
                </div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($pengumuman->previousPageUrl()); ?>" class="px-3 py-2 text-sm font-medium text-white bg-gray-800/50 border border-gray-700/50 rounded-lg hover:bg-teal-600/20 hover:border-teal-500/50 transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                        </a>
                    ...
                    <?php $__currentLoopData = $pengumuman->getUrlRange(1, $pengumuman->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($url); ?>" class="px-3 py-2 text-sm font-medium text-white bg-gray-800/50 border border-gray-700/50 rounded-lg hover:bg-teal-600/20 hover:border-teal-500/50 transition-all duration-300">
                                <?php echo e($page); ?>
                    ...
                    <?php if($pengumuman->hasMorePages()): ?>
                        <a href="<?php echo e($pengumuman->nextPageUrl()); ?>" class="px-3 py-2 text-sm font-medium text-white bg-gray-800/50 border border-gray-700/50 rounded-lg hover:bg-teal-600/20 hover:border-teal-500/50 transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\07_ProjectKuliah\yuwaraja2026\resources\views/mahasiswa/pengumuman/pengumuman.blade.php ENDPATH**/ ?>