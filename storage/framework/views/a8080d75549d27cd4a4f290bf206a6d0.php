...
<div class="min-h-screen bg-gradient-to-br from-[#0D1117] via-[#111827] to-[#0a0a0a] text-white p-4 sm:p-6 lg:p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <header class="mb-8 scroll-reveal">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div class="bg-gray-800/70 p-3 rounded-lg border border-gray-700 text-center w-full sm:w-auto">
                    <div class="font-poppins text-3xl font-bold bg-gradient-to-r from-teal-400 to-amber-400 bg-clip-text text-transparent"><?php echo e($pengumpulans->total()); ?></div>
        ...
        <!-- Daftar Pengumpulan -->
        <div class="space-y-5">
            <?php $__empty_1 = true; $__currentLoopData = $pengumpulans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pengumpulan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="scroll-reveal bg-gray-800/60 border border-gray-700 rounded-xl shadow-lg transition-all duration-300 hover:border-cyan-400/50 hover:shadow-cyan-500/10 hover:-translate-y-1"
                style="transition-delay: <?php echo e($index * 50); ?>ms">
                <div class="p-5 sm:p-6 relative">
                    <!-- Informasi Utama -->
                    <div class="mb-4">
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 mb-4">
                            <h3 class="font-poppins text-lg lg:text-xl font-bold text-white"><?php echo e($pengumpulan->tugas->judul ?? 'Tugas Dihapus'); ?></h3>
                            <span class="px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-full 
                                <?php if($pengumpulan->status == 'submitted'): ?> bg-amber-500/10 text-amber-400 
                                <?php elseif($pengumpulan->status == 'reviewed'): ?> bg-blue-500/10 text-blue-400
                                <?php elseif($pengumpulan->status == 'approved' || $pengumpulan->status == 'done'): ?> bg-green-500/10 text-green-400
                                <?php else: ?> bg-slate-500/10 text-slate-400 <?php endif; ?>">
                                <?php echo e($pengumpulan->status); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                            <div class="bg-gray-700/60 rounded-lg p-3">
                                ...
                                <p class="font-semibold text-white"><?php echo e($pengumpulan->user->name ?? 'User Dihapus'); ?></p>
                            </div>
                            <div class="bg-gray-700/60 rounded-lg p-3">
                                <p class="text-xs text-gray-400 mb-1">Dikumpulkan Pada</p>
                                <p class="font-semibold text-white"><?php echo e($pengumpulan->created_at->format('d M Y, H:i')); ?></p>
                            </div>
                            <div class="bg-gray-700/60 rounded-lg p-3">
                                <p class="text-xs text-gray-400 mb-1">Nilai</p>
                                <p class="font-semibold <?php echo e($pengumpulan->nilai ? 'text-cyan-400' : 'text-gray-500'); ?>">
                                    <?php echo e($pengumpulan->nilai ? $pengumpulan->nilai . ' / 100' : 'Belum Dinilai'); ?>
                        ...
                        <div class="mt-5">
                            <a href="<?php echo e(asset('storage/' . $pengumpulan->file_path)); ?>" target="_blank"
                    ...
                    <div class="absolute bottom-5 right-5">
                        <a href="<?php echo e(route('spv.tugas.pengumpulan.show', $pengumpulan->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LefiArchive\Tugas\kuliah\hima-bem\yuwaraja-new\resources\views/spv/pengumpulan/index.blade.php ENDPATH**/ ?>