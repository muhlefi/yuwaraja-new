<?php $__env->startSection('title', 'Review Pengumpulan Tugas'); ?>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <header class="bg-gray-800/70 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 mb-8 scroll-reveal">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <a href="<?php echo e(route('spv.pengumpulan.index')); ?>"
        ...
        <div class="bg-gray-800/60 border border-gray-700 rounded-lg shadow-lg p-6 mb-8 scroll-reveal">
            <h2 class="font-kanit text-2xl font-bold bg-gradient-to-r from-cyan-400 to-sky-400 bg-clip-text text-transparent mb-4">
                <?php echo e($pengumpulan->tugas->judul ?? 'Tugas Tidak Ditemukan'); ?>
                    ...
                    <div class="bg-gray-700/60 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white font-semibold"><?php echo e($pengumpulan->user->name ?? 'Tidak tersedia'); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-700/60 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white font-semibold">
                                    <?php if($pengumpulan->user && $pengumpulan->user->kelompok): ?>
                                    <?php echo e($pengumpulan->user->kelompok->nama_kelompok); ?>

                                    <?php elseif($pengumpulan->kelompok): ?>
                                    <?php echo e($pengumpulan->kelompok->nama_kelompok); ?>
                    ...
                    <div class="bg-gray-700/60 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white font-semibold"><?php echo e($pengumpulan->user->email ?? 'Tidak tersedia'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-700/60 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="status-badge status-<?php echo e(strtolower($pengumpulan->status)); ?>">
                    ...
                    <div class="bg-gray-700/60 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white font-semibold"><?php echo e($pengumpulan->submitted_at ? $pengumpulan->submitted_at->format('d M Y, H:i') : 'Belum dikumpulkan'); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-lg p-6 my-5 scroll-reveal">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <?php if($pengumpulan->keterangan): ?>
                        <p class="text-gray-300 leading-relaxed"><?php echo e($pengumpulan->keterangan); ?></p>
                        <?php else: ?>
        ...
        <div class="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl p-8 scroll-reveal">
            ...
            <form action="<?php echo e(route('spv.tugas.approve', $pengumpulan->id)); ?>" method="POST" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-3" id="score-section" style="display: none;">
                        ...
                        <div class="relative">
                            <input type="number" name="nilai" id="nilai"
                                ...
                                value="<?php echo e(old('nilai', $pengumpulan->nilai)); ?>"
                                min="0" max="100"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <select name="status" id="status"
                                ...
                                <option value="reviewed" <?php echo e($pengumpulan->status == 'reviewed' ? 'selected' : ''); ?>>
                                    🔍 Sedang Direview SPV
                                </option>
                                <option value="rejected" <?php echo e($pengumpulan->status == 'rejected' ? 'selected' : ''); ?>>
                                    ❌ Butuh Perbaikan
                                </option>
                                <option value="done" <?php echo e($pengumpulan->status == 'done' ? 'selected' : ''); ?>>
                                    ✅ Tugas Selesai
                                </option>
                            </select>
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        <textarea name="feedback" id="feedback" rows="5"
                            ...
                            placeholder="Berikan feedback konstruktif untuk membantu mahasiswa berkembang..."><?php echo e(old('feedback', $pengumpulan->feedback)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\07_ProjectKuliah\yuwaraja2026\resources\views/spv/tugas/detail-pengumpulan.blade.php ENDPATH**/ ?>