        ...
        <header class="mb-8 scroll-reveal">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-3 text-center w-full sm:w-auto">
                    <div class="font-kanit text-3xl font-bold bg-gradient-to-r from-teal-400 to-amber-400 bg-clip-text text-transparent"><?php echo e($tugas->total()); ?></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between md:items-start gap-4">
                        <div class="flex-grow">
                            ...
                            <p class="font-poppins text-gray-300 text-sm leading-relaxed mb-6">
                                <?php echo e(Str::limit($item->deskripsi, 250)); ?>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 text-sm">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-semibold text-white"><?php echo e(\Carbon\Carbon::parse($item->deadline)->format('d M Y, H:i')); ?></div>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-semibold text-white"><?php echo e($item->poin ?? 100); ?> Poin</div>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                     <?php if(\Carbon\Carbon::parse($item->deadline)->isPast()): ?>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-semibold text-white"><?php echo e(\Carbon\Carbon::parse($item->deadline)->diffForHumans()); ?></div>
                                    </div>
                                </div>
                                <div class="flex-shrink-0 mt-4 md:mt-0 md:ml-20">
                                     <button onclick="openTaskModal(<?php echo e($item->id); ?>)" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LefiArchive\Tugas\kuliah\hima-bem\yuwaraja-new\resources\views/spv/tugas/index.blade.php ENDPATH**/ ?>