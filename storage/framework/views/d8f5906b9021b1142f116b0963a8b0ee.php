            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="font-semibold text-white">
                            <?php echo e(\Carbon\Carbon::parse($tugas->deadline)->format('d M Y, H:i')); ?></div>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <svg class="w-6 h-6 text-teal-400/70 flex-shrink-0" fill="none" stroke="currentColor"
                    ...
                    <div>
                        ...
                        <div class="font-semibold text-white"><?php echo e($tugas->poin ?? 100); ?> Poin</div>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="font-semibold text-white"><?php echo e($pengumpulans->total()); ?> Mahasiswa</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bg-gray-700/60 border border-gray-600 rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="max-h-96 overflow-y-auto">
        <?php $__empty_1 = true; $__currentLoopData = $pengumpulans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengumpulan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                    <div class="flex-grow">
                        <div class="flex items-center gap-4 mb-3">
                            <div
                                ...
                                <?php echo e(substr($pengumpulan->user->name, 0, 1)); ?>

                            </div>
                            <div>
                                <h4 class="font-semibold text-white"><?php echo e($pengumpulan->user->name); ?></h4>
                                <p class="text-sm text-gray-400"><?php echo e($pengumpulan->user->email); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            <div>
                                ...
                                <span
                                    class="text-white font-medium"><?php echo e($pengumpulan->user->kelompok->nama ?? 'Belum ada Cluster'); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-400">Dikumpulkan:</span>
                                <span
                                    class="text-white font-medium"><?php echo e($pengumpulan->submitted_at ? $pengumpulan->submitted_at->format('d M Y, H:i') : '-'); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-400">Status:</span>
                                <span class="px-2 py-1 rounded-full text-xs font-medium
                                    <?php if($pengumpulan->status == 'pending'): ?> bg-yellow-900/50 text-yellow-300
                                    <?php elseif($pengumpulan->status == 'submitted'): ?> bg-blue-900/50 text-blue-300
                                    <?php elseif($pengumpulan->status == 'reviewed'): ?> bg-green-900/50 text-green-300
                                    <?php elseif($pengumpulan->status == 'approved'): ?> bg-green-900/50 text-green-300
                                    <?php elseif($pengumpulan->status == 'done'): ?> bg-purple-900/50 text-purple-300
                                    <?php else: ?> bg-gray-900/50 text-gray-300
                                    <?php endif; ?>">
                                    <?php echo e(ucfirst($pengumpulan->status)); ?>

                                </span>
                            </div>
                            <div>
                                <span class="text-gray-400">Nilai:</span>
                                <span class="text-white font-medium"><?php echo e($pengumpulan->nilai ?? '-'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-2">
                        <?php if($pengumpulan->file_path): ?>
                            <a href="<?php echo e(route('spv.tugas.pengumpulan.download', $pengumpulan->id)); ?>"
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('spv.tugas.pengumpulan.show', $pengumpulan->id)); ?>" target="_blank"
    ...
    <?php if($pengumpulans->hasPages()): ?>
        <div class="p-6 border-t border-gray-600">
            <?php echo e($pengumpulans->links()); ?>

        </div>
    <?php endif; ?>
</div><?php /**PATH D:\LefiArchive\Tugas\kuliah\hima-bem\yuwaraja-new\resources\views/spv/tugas/modal-content.blade.php ENDPATH**/ ?>