...
<div x-data="{ sidebarOpen: false }" class="relative">
    ...
    <aside :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
        ...
        <!-- Logo & Title -->
        <a href="<?php echo e(route('spv.dashboard')); ?>" class="flex flex-col items-center justify-center h-36 px-4 bg-black/30 border-b border-cyan-400/20 shrink-0">
...
<?php /**PATH D:\07_ProjectKuliah\yuwaraja2026\resources\views/components/sidebar-spv.blade.php ENDPATH**/ ?>