    ...
    <div class="container mx-auto p-4 md:p-6 lg:p-8">
        ...
        <header class="mb-8 md:mb-10">
            <div class="bg-gray-800/60 border border-teal-400/30 rounded-xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                ...
                <div class="bg-gray-800/70 border border-gray-700 rounded-lg p-4 text-center w-full md:w-auto">
                    <div class="text-4xl font-bold font-kanit bg-gradient-to-r from-teal-400 to-amber-400 bg-clip-text text-transparent"><?php echo e($pengumuman->total()); ?></div>
        ...
        <main>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php if($item->tipe === 'penting'): ?> border-red-400 
                <?php else: ?> border-teal-300/30 <?php endif; ?>
                p-6 transition-all duration-300 hover:shadow-xl hover:shadow-teal-500/10 hover:border-teal-400/70 transform hover:-translate-y-1 h-full flex flex-col">
                    ...
                    <div class="mb-4">
                        <div class="flex items-start justify-between mb-3">
                            <h3 class="text-lg font-bold font-kanit text-white line-clamp-2 flex-1"><?php echo e($item->judul); ?></h3>
                    ...
                    <div class="flex-1 mb-4">
                        <p class="text-gray-300 text-sm leading-relaxed">
                            <?php echo e(Str::limit($item->konten, 120)); ?>
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="flex items-center justify-between text-xs text-gray-400">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span><?php echo e($item->penulis ?? 'Admin'); ?></span>
                                </div>
                            </div>
                            <a href="<?php echo e(route('spv.pengumuman.detail', $item)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LefiArchive\Tugas\kuliah\hima-bem\yuwaraja-new\resources\views/spv/pengumuman/index.blade.php ENDPATH**/ ?>