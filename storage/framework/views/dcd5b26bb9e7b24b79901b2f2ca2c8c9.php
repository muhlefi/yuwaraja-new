    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <header class="flex flex-col sm:flex-row items-center gap-6 mb-12">
            <div class="relative flex-shrink-0 group">
                ...
                <img src="<?php echo e(asset('profile-pictures/'.Auth::user()->photo)); ?>" alt="Foto Profil" class="relative h-24 w-24 sm:h-28 sm:w-28 rounded-full object-cover border-2 border-gray-800">
                <?php else: ?>
                <div class="relative h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-gray-800 flex items-center justify-center border-2 border-gray-700">
                    <span class="font-display text-4xl font-bold text-teal-300"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                </div>
                <?php endif; ?>
            </div>
            <div>
                ...
                <p class="text-gray-400 text-sm mt-1 text-center sm:text-left">
                    <?php echo e(Auth::user()->program_studi ?? 'Program Studi Belum Diatur'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\07_ProjectKuliah\yuwaraja2026\resources\views/profile/edit.blade.php ENDPATH**/ ?>