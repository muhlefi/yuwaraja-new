        ...
        <div class="max-w-5xl mx-auto space-y-8">
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.2s;">
                <div class="p-6 md:p-10">
                    ...
                    <div class="mb-6">
                        <?php if($pengumuman->tipe === 'penting'): ?>
                    ...
                    <div class="border-b border-slate-700/50 pb-8 mb-8">
                        <h1 class="font-display text-3xl md:text-5xl font-bold text-white mb-6 leading-tight"><?php echo e($pengumuman->judul); ?></h1>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 sm:gap-8">
                            <div class="meta-info">
                                ...
                                <span><?php echo e($pengumuman->created_at->format('d F Y, H:i')); ?></span>
                            </div>
                            <div class="meta-info">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center pt-6 border-t border-slate-700/50">
                        <a href="<?php echo e(route('spv.pengumuman.index')); ?>" class="btn-primary">
                        ...
                        <div class="flex items-center gap-2 text-sm text-slate-500">
                            ...
                            <span>Terakhir diperbarui: <?php echo e($pengumuman->updated_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LefiArchive\Tugas\kuliah\hima-bem\yuwaraja-new\resources\views/spv/pengumuman-detail.blade.php ENDPATH**/ ?>