    ...
    public function handle()
    {
        ...
        if ($count < 2) {
            ...
            Pengumuman::create([
                ...
                'tipe' => 'umum',
                'is_published' => true,
                'published_at' => Carbon::parse('2026-07-13 00:29:37'),
                'created_at' => Carbon::parse('2026-07-12 17:29:42'),
                'updated_at' => Carbon::parse('2026-07-12 23:03:48'),
            ]);
            ...
            Pengumuman::create([
                ...
                'tipe' => 'umum',
                'is_published' => true,
                'published_at' => Carbon::parse('2026-07-14 07:40:27'),
                'created_at' => Carbon::parse('2026-07-12 17:40:40'),
                'updated_at' => Carbon::parse('2026-07-12 23:03:55'),
            ]);
